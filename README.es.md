...
| M4 🟡 | **Benchmark — go/no-go**. Runner ✅ | Mejora ≥ umbral pre-registrado en ≥ 2 de A/C/D, cero regresión frente a S0. El runner está y **se niega a correr**: `bench/PREREG.md` sigue en borrador con 21 `TODO(Matias)` |
...
`bench/PREREG.md` dice **BORRADOR — no congelado** y tiene 21 `TODO(Matias)`. Hasta que
