...
- [`experimentos/hipotesis/`](experimentos/hipotesis/) — una hipótesis por archivo: **24 hipótesis**. Al 2026-08-28: **22 comprobadas**, 1 en contra y 1 esperando material — `make experiments` las recorre. La que falla es la apuesta del propio proyecto
